    ...
    return (
        <>
            <div className='p-4 p-lg-5'>
                ...
                <div className='about-img'>
                    <div className='overlay'>
                        ...
                        <div className="mx-3 mx-sm-2 mx-md-3 mx-lg-4 content-center" style={{ height: '60vh' }}>
                            <div className='p-sm-5 text-green text-transrom-uppercase'>
                ...
                <div className='py-5'>
                    <h2 className='fw-bold text-green mb-3'>Categories</h2>
                ...
                <div>
                    <h2 className='fw-bold text-green mb-3'>About Us</h2>
